 ...
 *
 * İkisi de tutmazsa `null`: konuma geri düşmek tam da kaçınılan hatayı geri
 * getirirdi — yanlış kalemin fiyatını doğru kalemin satırına yazmak. Eşleşme
 * bilgisiz kalsın, yanlış olmasın.
 */
