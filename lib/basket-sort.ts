/**
 * Sepet listesi sıralama anahtarları. Hem sunucu sorgusu (orderBy) hem de
 * /sepetlerim sayfasındaki sıralama menüsü bunu kullanır. Sıralama SUNUCU
 ...
 */
export type BasketSort = "date_desc" | "date_asc" | "name_asc" | "name_desc"
